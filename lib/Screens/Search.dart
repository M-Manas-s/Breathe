...
class _SearchState extends State<Search> with TickerProviderStateMixin {
  ...
  closestTen() {
    vendorList.sort((a, b) => (calculateDistance(a.location, userLoc))
        .compareTo(calculateDistance(b.location, userLoc)));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Center(
        child: (loaded && vendorList.length == 0)
            ? Center(
                child: Text("No Vendors supplying Oxygen Cylinders near you",
